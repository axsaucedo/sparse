...
% Selecting only a subset of time window:
T = 100;
R = R(:,1:T);
I = I(1:T);
wsize   = 60;
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %     
    ...
    pimat_l     = rs.sglasso(I_train,R_train,groups,0,0.01);
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %    
    ...
    pimat_gl     = rs.sglasso(I_train,R_train,groups,.7,0);
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %    
    ...
    pimat_sgl300     = rs.sglasso(I_train,R_train,groups,.5/500,.5);
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %    
    ...
    pimat_sgl3000     = rs.sglasso(I_train,R_train,groups,0.05/5000,0.05);
